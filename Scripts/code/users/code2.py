...
file_path = "D:/张广倍大学/张广倍科研/爬虫新_2024.7/代码汇总/爬用户/12501-.xlsx"
...
if __name__ == '__main__':
    if os.path.exists("D:/张广倍大学/张广倍科研/爬虫新_2024.7/代码汇总/爬用户/page2.txt"):
        last_page = open("D:/张广倍大学/张广倍科研/爬虫新_2024.7/代码汇总/爬用户/page2.txt", 'r').read()
        page = int(last_page)
    else:
        page = 0
    ...
    while True:
        ...
        page += 1
        with open("D:/张广倍大学/张广倍科研/爬虫新_2024.7/代码汇总/爬用户/page2.txt", 'w') as f:
            f.write(f'{page}')
